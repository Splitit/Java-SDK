...
import com.splitit.sandbox.webapiv3.exceptions.OAuthProviderException;
...
public final class OAuthAuthorizationController extends BaseController {
     ...
     */
    public OAuthToken requestTokenOAuth2Sandbox(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) throws ApiException, IOException {
        return prepareRequestTokenOAuth2SandboxRequest(authorization, scope,
     ...
     * @return    Returns the OAuthToken response from the API call
     */
    public CompletableFuture<OAuthToken> requestTokenOAuth2SandboxAsync(
            final String authorization,
            final String scope,
    ...
    /**
     * Builds the ApiCall object for requestTokenOAuth2Sandbox.
     */
    private ApiCall<OAuthToken, ApiException> prepareRequestTokenOAuth2SandboxRequest(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public OAuthToken requestTokenOAuth2Production(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) throws ApiException, IOException {
        return prepareRequestTokenOAuth2ProductionRequest(authorization, scope,
                fieldParameters).execute();
    }
     ...
     * @return    Returns the OAuthToken response from the API call
     */
    public CompletableFuture<OAuthToken> requestTokenOAuth2ProductionAsync(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) {
        try {
    ...
    /**
     * Builds the ApiCall object for requestTokenOAuth2Production.
     */
    private ApiCall<OAuthToken, ApiException> prepareRequestTokenOAuth2ProductionRequest(
            final String authorization,
            final String scope,
            final Map<String, Object> fieldParameters) {
        return new ApiCall.Builder<OAuthToken, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ACCESS_TOKEN_SERVER1.value())
                        .path("/token")
                        .formParam(param -> param.key("grant_type")
                                .value("client_credentials").isRequired(false))
                        .formParam(param -> param.key("scope")
