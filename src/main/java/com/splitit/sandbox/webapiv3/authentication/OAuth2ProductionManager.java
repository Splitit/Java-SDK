 ...
 */
public class OAuth2ProductionManager extends HeaderAuth implements OAuth2ProductionCredentials {
     ...
     */
    private OAuth2ProductionModel authModel;
     ...
     * Constructor.
     */
    public OAuth2ProductionManager(OAuth2ProductionModel authModel) {
    ...
    */
    ...
    /**
     * Converts this OAuth2ProductionManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OAuth2ProductionManager [" + "oAuthClientId=" + getOAuthClientId()
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(
        ...
        return oAuthApi.requestTokenOAuth2ProductionAsync(
    ...
    public OAuthToken fetchToken(Map<String, Object> additionalParameters)
        ...
        OAuthToken token = oAuthApi.requestTokenOAuth2Production(
            getBasicAuthForClient(),
            stringJoin(getOAuthScopes(), " "),
            aparams);
    ...
    */
    ...
    public String getErrorMessage() {
        ...
        return "OAuth2Production - " + errorMessage;
    }
