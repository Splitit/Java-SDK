 ...
 */
public class OAuth2SandboxModel {
    private String oAuthClientId;
    private String oAuthClientSecret;
    private OAuthToken oAuthToken;
    private List<OAuthScopeOAuth2SandboxEnum> oAuthScopes;
    private BiFunction<OAuthToken, OAuth2SandboxCredentials, OAuthToken> oAuthTokenProvider;
    private Consumer<OAuthToken> oAuthOnTokenUpdate;
    private long oAuthClockSkew;

    /**
     * A Constructor for OAuth2SandboxModel.
     */
    private OAuth2SandboxModel(String oAuthClientId, String oAuthClientSecret,
            OAuthToken oAuthToken, List<OAuthScopeOAuth2SandboxEnum> oAuthScopes,
            BiFunction<OAuthToken, OAuth2SandboxCredentials, OAuthToken> oAuthTokenProvider,
     ...
     */
    public List<OAuthScopeOAuth2SandboxEnum> getOAuthScopes() {
     ...
     */
    public BiFunction<OAuthToken, OAuth2SandboxCredentials, OAuthToken> getOAuthTokenProvider() {
    ...
    /**
     * Builds a new {@link OAuth2SandboxModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link OAuth2SandboxModel.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthScopes(List<OAuthScopeOAuth2SandboxEnum> oAuthScopes) {
            this.oAuthScopes = oAuthScopes;
            return this;
        }
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthTokenProvider(BiFunction<OAuthToken, OAuth2SandboxCredentials, OAuthToken> oAuthTokenProvider) {
            this.oAuthTokenProvider = oAuthTokenProvider;
            return this;
        }
        ...
        /**
         * Builds the instance of OAuth2SandboxModel using the provided credentials.
         * @return The instance of OAuth2SandboxModel.
         */
        public OAuth2SandboxModel build() {
            return new OAuth2SandboxModel(oAuthClientId, oAuthClientSecret, oAuthToken, oAuthScopes,
