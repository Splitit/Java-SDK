 ...
 */
public class OAuth2SandboxManager extends HeaderAuth implements OAuth2SandboxCredentials {
     ...
     */
    private OAuth2SandboxModel authModel;
     ...
     * Constructor.
     */
    public OAuth2SandboxManager(OAuth2SandboxModel authModel) {
    ...
    */
    ...
    /**
     * List of OAuthScopeOAuth2SandboxEnum value for oAuthScopes.
     * @return oAuthScopes
     */
     ...
     * @param oAuthScopes List of OAuthScopeOAuth2SandboxEnum value for credentials.
     * @return true if credentials matched.
     */
    public boolean equals(String oAuthClientId, String oAuthClientSecret, OAuthToken oAuthToken,
            List<OAuthScopeOAuth2SandboxEnum> oAuthScopes) {
    ...
    /**
     * Converts this OAuth2SandboxManager into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "OAuth2SandboxManager [" + "oAuthClientId=" + getOAuthClientId()
    ...
    public CompletableFuture<OAuthToken> fetchTokenAsync(
        ...
        return oAuthApi.requestTokenOAuth2SandboxAsync(
    ...
    public OAuthToken fetchToken(Map<String, Object> additionalParameters)
        ...
        OAuthToken token = oAuthApi.requestTokenOAuth2Sandbox(
            getBasicAuthForClient(),
            stringJoin(getOAuthScopes(), " "),
            aparams);
    ...
    */
    ...
    public String getErrorMessage() {
        ...
        return "OAuth2Sandbox - " + errorMessage;
    }
