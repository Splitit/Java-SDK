 ...
 */
public class OAuth2ProductionModel {
    private String oAuthClientId;
    private String oAuthClientSecret;
    private OAuthToken oAuthToken;
    private List<OAuthScopeOAuth2ProductionEnum> oAuthScopes;
    private BiFunction<OAuthToken, OAuth2ProductionCredentials, OAuthToken> oAuthTokenProvider;
    private Consumer<OAuthToken> oAuthOnTokenUpdate;
    private long oAuthClockSkew;

    /**
     * A Constructor for OAuth2ProductionModel.
     */
    private OAuth2ProductionModel(String oAuthClientId, String oAuthClientSecret,
            OAuthToken oAuthToken, List<OAuthScopeOAuth2ProductionEnum> oAuthScopes,
            BiFunction<OAuthToken, OAuth2ProductionCredentials, OAuthToken> oAuthTokenProvider,
     ...
     */
    public List<OAuthScopeOAuth2ProductionEnum> getOAuthScopes() {
     ...
     */
    public BiFunction<OAuthToken, OAuth2ProductionCredentials, OAuthToken> getOAuthTokenProvider() {
    ...
    /**
     * Builds a new {@link OAuth2ProductionModel.Builder} object.
     * Creates the instance with the state of the current auth model.
     * @return a new {@link OAuth2ProductionModel.Builder} object.
     */
    ...
    public static class Builder {
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthScopes(List<OAuthScopeOAuth2ProductionEnum> oAuthScopes) {
            this.oAuthScopes = oAuthScopes;
            return this;
        }
         ...
         * @return Builder The current instance of Builder.
         */
        public Builder oAuthTokenProvider(BiFunction<OAuthToken, OAuth2ProductionCredentials, OAuthToken> oAuthTokenProvider) {
            this.oAuthTokenProvider = oAuthTokenProvider;
            return this;
        }
        ...
        /**
         * Builds the instance of OAuth2ProductionModel using the provided credentials.
         * @return The instance of OAuth2ProductionModel.
         */
        public OAuth2ProductionModel build() {
            return new OAuth2ProductionModel(oAuthClientId, oAuthClientSecret, oAuthToken,
